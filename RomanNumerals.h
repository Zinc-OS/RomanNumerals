...
//returns the integer value of the roman numerals stored in string rn
int fromRomanNumerals(char* rn);
//stores the roman numerals value of integer rn  in string orn if orn is not null
//returns the length of the string required to stire the roman numerals
